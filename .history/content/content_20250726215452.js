...
class AmazonProductExtractor {
  ...
  showPriceComparison(amazonProduct, temuProduct) {
    ...
    popup.innerHTML = `
      <div style="position: relative;">
        <button id="temu-popup-close" style="position: absolute; top: -8px; right: -8px; background: #666; color: white; border: none; border-radius: 50%; width: 20px; height: 20px; font-size: 14px; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 10003;">×</button>
        <div style="font-weight: bold; color: #fb7701; font-size: 16px; margin-bottom: 8px;">Temu Price Comparison</div>
        <div style="color: #228B22; font-size: 20px; font-weight: bold; margin-bottom: 8px;">
          Save $${savings.toFixed(2)} (${savingsPercent}%)
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom: 4px;">
          <span>Amazon:</span><span style="font-weight: bold;">$${amazonPrice.toFixed(2)}</span>
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
          <span>Temu:</span><span style="color: #fb7701; font-weight: bold;">$${temuPrice.toFixed(2)}</span>
        </div>
        <button id="temu-popup-buy" style="width: 100%; background: #fb7701; color: #fff; border: none; border-radius: 6px; padding: 10px; font-weight: bold; font-size: 15px; cursor: pointer;">Buy on Temu</button>
      </div>
    `;
