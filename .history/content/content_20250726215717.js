...
class AmazonProductExtractor {
  ...
  createTemuPopup(temuProduct, btn) {
    ...
    popup.innerHTML = `
      <div style="position: relative;">
        <button id="temu-popup-close" style="position: absolute; top: 8px; right: 8px; background: rgba(255, 255, 255, 0.2); color: white; border: none; border-radius: 50%; width: 20px; height: 20px; font-size: 14px; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 10003;">×</button>
        
        <div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); color: white; padding: 12px 16px; display: flex; justify-content: space-between; align-items: center; position: relative; overflow: hidden;">
          <div style="font-size: 16px; font-weight: 700; position: relative; z-index: 1;">Temu Price Comparison</div>
          <div style="font-size: 10px; opacity: 0.9; background: rgba(255, 255, 255, 0.2); padding: 2px 6px; border-radius: 10px; font-weight: 500; position: relative; z-index: 1;">v2.2.2</div>
        </div>
        
        <div style="padding: 10px 16px;">
          <div style="margin: 0 0 6px 0; font-size: 14px; font-weight: 600; color: #2c3e50; display: flex; align-items: center; gap: 6px;">💰 Savings Found</div>
          
          <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 10px; border: 1px solid #e9ecef; padding: 12px; box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.06);">
            <div style="color: #27ae60; font-size: 18px; font-weight: 700; margin-bottom: 12px; text-align: center;">
              Save $${savings.toFixed(2)} (${savingsPercent}%)
            </div>
            
            <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 13px;">
              <span style="color: #2c3e50;">Amazon:</span>
              <span style="font-weight: 700; color: #2c3e50;">$${amazonPrice.toFixed(2)}</span>
            </div>
            <div style="display: flex; justify-content: space-between; font-size: 13px;">
              <span style="color: #2c3e50;">Temu:</span>
              <span style="color: #e74c3c; font-weight: 700;">$${temuPrice.toFixed(2)}</span>
            </div>
          </div>
          
          <button id="temu-popup-buy" style="width: 100%; background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); color: white; border: none; border-radius: 8px; padding: 12px; font-weight: 700; font-size: 14px; cursor: pointer; transition: all 0.2s ease; margin-top: 12px;">Buy on Temu</button>
        </div>
      </div>
    `;
    ...
    // Close button action
    popup.querySelector('#temu-popup-close').onclick = () => {
      popup.remove();
      popup = null;
    };
  ...
  showPriceComparison(amazonProduct, temuProduct) {
    ...
    popup.innerHTML = `
      <div style="position: relative;">
        <button id="temu-popup-close" style="position: absolute; top: -8px; right: -8px; background: #666; color: white; border: none; border-radius: 50%; width: 20px; height: 20px; font-size: 14px; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 10003;">×</button>
        
        <div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); color: white; padding: 12px 16px; margin: -16px -16px 12px -16px; border-radius: 12px 12px 0 0; display: flex; justify-content: space-between; align-items: center;">
          <div style="font-weight: 700; font-size: 16px;">Temu Price Comparison</div>
          <div style="font-size: 10px; opacity: 0.9; background: rgba(255, 255, 255, 0.2); padding: 2px 6px; border-radius: 10px;">v2.2.1</div>
        </div>
        ...
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 8px; padding: 12px; margin-bottom: 12px; border: 1px solid #e9ecef;">
          <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 13px;">
            <span style="color: #2c3e50;">Amazon:</span>
            <span style="font-weight: 700; color: #2c3e50;">$${amazonPrice.toFixed(2)}</span>
          </div>
        ...
        <button id="temu-popup-buy" style="width: 100%; background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); color: white; border: none; border-radius: 8px; padding: 12px; font-weight: 700; font-size: 14px; cursor: pointer; transition: all 0.2s ease;">Buy on Temu</button>
      </div>
    `;
...
function showSearchResultsPopup(amazonProduct, bestMatch, searchUrl) {
  ...
  popup.innerHTML = `
    <div style="position: relative;">
      <button id="close-search-popup" style="position: absolute; top: -8px; right: -8px; background: #666; color: white; border: none; border-radius: 50%; width: 20px; height: 20px; font-size: 14px; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 10003;">×</button>
      
      <div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); color: white; padding: 12px 16px; margin: -16px -16px 12px -16px; border-radius: 12px 12px 0 0; display: flex; justify-content: space-between; align-items: center;">
        <div style="font-weight: 700; font-size: 16px;">🎯 Found Match on Temu!</div>
        <div style="font-size: 10px; opacity: 0.9; background: rgba(255, 255, 255, 0.2); padding: 2px 6px; border-radius: 10px;">v2.2.1</div>
      </div>
      
      <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 8px; padding: 12px; margin-bottom: 12px; border: 1px solid #e9ecef;">
        <div style="font-size: 13px; margin-bottom: 8px; color: #2c3e50;">
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 13px;">
          <span style="color: #2c3e50;">Amazon: <strong>$${amazonPrice.toFixed(2)}</strong></span>
          <span style="color: #e74c3c; font-weight: 700;">Temu: <strong>${bestMatch.price}</strong></span>
        </div>
        ${savings > 0 ? `
          <div style="text-align: center; color: #27ae60; font-weight: 700; font-size: 14px;">
            💰 Save ${savings}%!
          </div>
        ` : ''}
      </div>
