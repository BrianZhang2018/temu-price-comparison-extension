...
function showSearchResultsPopup(amazonProduct, bestMatch, searchUrl) {
  ...
  popup.innerHTML = `
    <div style="position: relative;">
      <button id="close-search-popup" style="position: absolute; top: 8px; right: 8px; background: rgba(255, 255, 255, 0.2); color: white; border: none; border-radius: 50%; width: 20px; height: 20px; font-size: 14px; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 10003;">×</button>
      
      <div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); color: white; padding: 12px 16px; display: flex; justify-content: space-between; align-items: center; position: relative; overflow: hidden;">
        <div style="font-size: 16px; font-weight: 700; position: relative; z-index: 1;">🎯 Found Match on Temu!</div>
        <div style="font-size: 10px; opacity: 0.9; background: rgba(255, 255, 255, 0.2); padding: 2px 6px; border-radius: 10px; font-weight: 500; position: relative; z-index: 1;">v2.2.2</div>
      </div>
      
      <div style="padding: 10px 16px;">
        <div style="margin: 0 0 6px 0; font-size: 14px; font-weight: 600; color: #2c3e50; display: flex; align-items: center; gap: 6px;">📦 Product Comparison</div>
